...
// // const upload = multer({ storage: storage }).single("profileImage"); // 'profileImage' is the name attribute of the file input field in the form
...
//   // Determine the field name based on the user's role
//   let fieldName;
...
//   // Use the determined field name for multer upload
...
//       const updateQuery = `UPDATE ${tableName} SET profile_image = ? WHERE email = ?1`;
